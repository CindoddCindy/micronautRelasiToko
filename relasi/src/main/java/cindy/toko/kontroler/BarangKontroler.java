...
import cindy.toko.repositori.BarangInterface;

@Controller("/barang")
public class BarangKontroler{

    private BarangInterface repository;
    
    BarangKontroler(BarangInterface r){
        this.repository = r;
    }

    @Get(produces = MediaType.APPLICATION_JSON)
    public String index(@QueryValue int page, @QueryValue int limit) {
        List<Barang> barang = repository.findAll(page, limit);
    ...
    public String save(@Body Barang t) {
        HashMap<String, Object> data = new HashMap<>();
    ...
    public String update(@Body Barang c) {
        HashMap<String, Object> data = new HashMap<>();
        if (repository.update(c.getId(),c.getIdBarang(), c.getNama())) {
